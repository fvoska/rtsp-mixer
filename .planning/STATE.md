...
Last activity: 2026-09-19 -- Completed quick task 260919-foa: level-driven card glow and 60 s waveform from one noise-floor-relative sound level
...
| 260919-foa | 2026-09-19 | rethink-the-activity-monitor-level-drive | Replace variation-based activity with a noise-floor-relative smoothed level (`AudioLevelTracker`, 250 ms poll) that drives the card border/halo directly and a 60 s waveform of the same series with threshold guides; `levelThreshold` setting (default 0.25, new key) replaces `activityThreshold` | [PLAN](quick/260919-foa-rethink-the-activity-monitor-level-drive/260919-foa-PLAN.md) · [SUMMARY](quick/260919-foa-rethink-the-activity-monitor-level-drive/260919-foa-SUMMARY.md) |
