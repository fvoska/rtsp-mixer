...
Last activity: 2026-07-27 -- Completed quick task 260727-pzo: native PCM level metering sidecar + branch-build CI
...
| 260727-pzo | 2026-07-27 | native-pcm-metering | Real audio metering: per-camera native Android analyzer sidecar (media3 ExoPlayer RTSP + TeeAudioProcessor PCM tap → RMS/peak dBFS over EventChannel) replaces the bitrate proxy on Android; activity = smoothed excess over adaptive noise floor (`ActivityDetector`); bitrate proxy kept as fallback (desktop / sidecar stale); debug panel Meter row; new branch-build CI workflow for installable APKs from any branch | [PLAN](quick/260727-pzo-replace-bitrate-spl-metering-with-native/260727-pzo-PLAN.md) · [SUMMARY](quick/260727-pzo-replace-bitrate-spl-metering-with-native/260727-pzo-SUMMARY.md) |
