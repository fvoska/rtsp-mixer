...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/rtsp-mixer/.claude/.gsd-surface.json`
(sibling to `/home/user/rtsp-mixer/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/rtsp-mixer/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/rtsp-mixer/.claude/skills`).
...
`/home/user/rtsp-mixer/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/rtsp-mixer/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/rtsp-mixer/.claude/.gsd-surface.json`
Install profile marker: `/home/user/rtsp-mixer/.claude/.gsd-profile`
Skill dirs: `/home/user/rtsp-mixer/.claude/skills/gsd-*/`
Engine module: `/home/user/rtsp-mixer/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/rtsp-mixer/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
