...
<execution_context>
@/home/user/rtsp-mixer/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/rtsp-mixer/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
