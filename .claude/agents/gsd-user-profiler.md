...
<reference>
@/home/user/rtsp-mixer/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/rtsp-mixer/.claude/gsd-core/references/user-profiling.md` to load:
