...
Reference full template: `/home/user/rtsp-mixer/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/rtsp-mixer/.claude/gsd-core/templates/state.md`.
