...
```markdown
Read /home/user/rtsp-mixer/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/rtsp-mixer/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/rtsp-mixer/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/rtsp-mixer/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/rtsp-mixer/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/rtsp-mixer/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/rtsp-mixer/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
