...
ones). Reference: @/home/user/rtsp-mixer/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/rtsp-mixer/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/rtsp-mixer/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/rtsp-mixer/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/rtsp-mixer/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/rtsp-mixer/.claude/gsd-core/templates/spec.md.
