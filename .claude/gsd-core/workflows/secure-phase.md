...
```
Agent(
  prompt="Read /home/user/rtsp-mixer/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/rtsp-mixer/.claude/gsd-core/templates/SECURITY.md`
